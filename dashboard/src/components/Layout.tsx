...
const allNavItems = [
  ...
  { to: '/scheduled', icon: Clock, key: 'scheduled' as const, adminOnly: false },
  { to: '/templates', icon: LayoutTemplate, key: 'templates' as const, adminOnly: false },
  { to: '/message-tester', icon: Send, key: 'messageTester' as const, adminOnly: false },
  { to: '/google-sheets', icon: Sheet, key: 'googleSheets' as const, adminOnly: false },
